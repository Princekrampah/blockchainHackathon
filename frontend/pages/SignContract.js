    ...
    if (active) {
      ...
      try {
        ...
        swal({
          ...
          text: "An email has been sent to the service provider. Kindly wait for thier response",
          icon: "success",
          button: "Okay",
        }).then(
          router.push("/")
  ...
  return (
    ...
    <main className={styles.main}>
        ...
        <form className='form-group' onSubmit={onSubmit}>
            ...
            <p>By signing this contract, you agree to the terms and conditions of service provide as stated in the services listing. </p>
            <div>
